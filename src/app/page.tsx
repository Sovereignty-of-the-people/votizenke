...
import { Users, ArrowRight, BarChart3, Award, Target, TrendingUp, Shield, BookOpen, Zap, Globe } from "lucide-react";
...
export default function Home() {
  ...
  const actionCards = [
    ...
    },
    {
      ...
      link: isAuthenticated ? "/voter-registration" : "/auth/signin"
    },
    {
  ...
  const features = [
    ...
    },
    {
      ...
      link: isAuthenticated ? "/leadership" : "/auth/signin"
    },
    {
      icon: Target,
      ...
      link: isAuthenticated ? "/campaign" : "/auth/signin"
    },
    {
      icon: BarChart3,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href={isAuthenticated ? "/voter-registration" : "/auth/signin"}>
